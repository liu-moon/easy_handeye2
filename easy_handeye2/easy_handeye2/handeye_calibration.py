...
class HandeyeCalibrationParametersProvider:
    def __init__(self, node: Node):
        ...
        self.node.declare_parameter('name','eye_in_hand_calibration', descriptor=ParameterDescriptor(type=ParameterType.PARAMETER_STRING))
        ...
        self.node.declare_parameter('robot_base_frame','panda_link0', descriptor=ParameterDescriptor(type=ParameterType.PARAMETER_STRING))
        self.node.declare_parameter('robot_effector_frame','panda_link8', descriptor=ParameterDescriptor(type=ParameterType.PARAMETER_STRING))
